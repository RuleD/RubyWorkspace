  ...
  module Helpers
    ...
    class Gantt
      ...
      def subject_for_issue(issue, options)
        ...
        if issue.assigned_to.respond_to? 'name'
          issue_subject+='('+issue.assigned_to.name+')'#The Gantt chart added assigned_to
        end
        subject(issue_subject, options, issue)
      end
